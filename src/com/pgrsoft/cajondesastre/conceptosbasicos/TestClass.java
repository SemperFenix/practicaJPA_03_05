...
OUTER:	for(int i = 0; i < 9 ; i++ ){
	...
	/*
	 * Devuelve el precio de un producto + IVA
	 * 
	 * p: precio
	 * i: IVA
	 * 
	 * Ejemplo: gi(100.0, 20.0) devuelve 120.0
	 * 
	 * 
	 */
	public double gi(double p, double i) {
		return p+p*i/100;
	}
	...
	public void abrirBotellasDeLicor() {
	...
	public double getPrecioMasIva(double precio, double iva) {
